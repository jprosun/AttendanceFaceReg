...
class Student:
    def __init__(self,root):
        ...
        self.heading = Label(self.root, text=self.txt, font=("Times New Roman", 28, "bold"), bg="white", fg="#608def",
                             bd=5, relief=FLAT)
        self.heading.place(x=400, y=35, width=650)
        # self.slider()
        # self.heading_color()
        ...
        #class
            # ——— Lấy danh sách class từ bảng `class`
        import mysql.connector
        ...
        class_list = [r[0] for r in rows]  # ví dụ ['QT01', 'QT02', ...]

            # ——— Tạo label và Combobox cho Lớp học
        class_div_label = Label(class_student_frame, text="Lớp học:",
        ...
        class_div_combo.set("Chọn lớp")  # mặc định hiển thị
    ...
    #roll
        ...
        save_btn=Button(btn_frame,text="Thêm",command=self.add_data,font=("times new roman",13,"bold"),bg="#38a6f0", fg="white",width=17)
    ...
    def reset_data(self):
        ...
        self.var_std_id.set(self.getNextid()),
        ...
        if self.var_dep.get()=="Chọn chuyên ngành" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                def face_cropped(img):
                    ...
                    gray = cv2.GaussianBlur(gray, (5,5), 0) # Khử nhiễu
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        folder_path = os.path.join("data", "student_" + f"{id}")
    ...
    def train_classifier(self):
        ...
        data_dir = os.path.join("data", "student_" + f"{id}")
        ...
        model_path = os.path.join("classifier.xml")
